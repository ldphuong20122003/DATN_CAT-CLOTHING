...
router.get('/', async(req, res, next) =>{
  ...
  router.post('/add',async(req,res,next)=>{
    try {
      ...
      const docRef = await db.collection('Order Details').add(data);
  ...
  router.delete('/delete/:id',async(req,res,next)=>{
    try {
      ...
      await db.collection('Order Details').doc(docId).delete();
  ...
  router.put('/update/:id',async(req,res,next)=>{
    try {
      ...
      await db.collection('Order Details').doc(docId).set(newData, { merge: true });

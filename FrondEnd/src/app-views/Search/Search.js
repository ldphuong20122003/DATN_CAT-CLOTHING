...
const Search = ({navigation}) => {
  ...
  const visibleItems = showAllItems ? searchHistory : (searchHistory ? searchHistory.slice(0, 3) : []);
    ...
    <SafeAreaView>
      <View style={styles.Header}>
        ...
        >
          ...
          <TouchableOpacity onPress={() => saveSearchHistory(text_search)}>
      ...
      <Text style={{fontSize:14,fontWeight:600,marginTop:10}}>Lịch sử tìm kiếm</Text>

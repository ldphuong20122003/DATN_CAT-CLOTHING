        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            >
                <View style={{ flexDirection: "row", marginLeft: 20 }}>
                    ...
                    <View style={{width: 20, height: 20, borderRadius: 50, borderWidth: 1, borderColor: '#1890FF',alignItems:'center'}}>
                        <Text style={{width: 10, height:10, backgroundColor: '#1890FF', borderRadius:50,borderColor:'#1890FF', borderWidth:1, marginTop: 4}}/>
                    </View>
                </View>

    ...
    <View style={styles.Container}>
      <View style={styles.Header}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <TouchableOpacity onPress={gotoBack}>
            <SvgXml xml={BackSvg("#000")} style={{ width: 24, height: 24 }} />
          </TouchableOpacity>
          <View
            style={{
              flex: 1,
      ...
      <View style={styles.Content}>
        ...
        >
          ...
          <TextInput style={{ marginLeft: 8 }} placeholder="Tìm kiếm" />
        </View>
        <View>
          <ListChat data={default_data1} />
        </View>
      </View>
    </View>
  );
